...
main:
# $s0 is the origional string
# $s1 is the search character
# $t0 is the return value from strcontainsi, 0 is not found, 1 is found
#Get String input
...
# Get char input
  la    $a0, prompt_char    # load the address of promote into $a0
